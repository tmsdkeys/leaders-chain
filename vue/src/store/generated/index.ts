...
import TmsdkeysLeadersTmsdkeysLeadersLeaders from './tmsdkeys/leaders/tmsdkeys.leaders.leaders'
...
export default { 
  ...
  TmsdkeysLeadersTmsdkeysLeadersLeaders: load(TmsdkeysLeadersTmsdkeysLeadersLeaders, 'tmsdkeys.leaders.leaders'),
